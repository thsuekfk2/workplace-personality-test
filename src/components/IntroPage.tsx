          ...
          <div className="space-y-6 text-left">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  총 10문항으로 약 3-5분 정도 소요됩니다. 중간에 페이지를
                  새로고침해도 진행상황이 저장됩니다.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  8가지 직장인 유형 중 당신에게 맞는 유형을 찾아드리며, 각
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  너무 오래 고민하지 마세요! 첫 번째 직감이 가장 정확한 답일 수
                  있습니다. 실제 직장에서의 경험을 떠올리며 답변해보세요.
                </p>
              </div>
            </div>
          </div>

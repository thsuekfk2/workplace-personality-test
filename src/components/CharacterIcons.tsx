    ...
    case "innovator":
      return (
        ...
        >
          ...
          />
          <path
            d="M42 20 L45 15 M50 18 L50 12 M58 20 L55 15"
            stroke="#FFA500"
            strokeWidth="2"
          />
          <path
            d="M30 30 L25 25 M70 30 L75 25"
            stroke="#FFA500"
            strokeWidth="2"
          />
        </svg>
    ...
    case "communicator":
      return (
        ...
        >
          ...
          <path
            d="M20 32 Q15 35 20 38"
            stroke="#45B7D1"
            strokeWidth="2"
            fill="none"
          />
          <path
            d="M80 32 Q85 35 80 38"
            stroke="#45B7D1"
            strokeWidth="2"
            fill="none"
          />
    ...
    case "supporter":
      return (
        ...
        >
          ...
          />
          <path
            d="M50 25 L55 35 L65 35 L57 42 L60 52 L50 47 L40 52 L43 42 L35 35 L45 35 Z"
            fill="#F39C12"
          />
    ...
    case "emotion":
      return (
        ...
        >
          ...
          />
          <polygon
            points="50,15 55,25 67,25 58,33 62,45 50,38 38,45 42,33 33,25 45,25"
            fill="#FFD700"
            stroke="#E74C3C"
            strokeWidth="2"
          />
    ...
    case "creator":
      return (
        ...
        >
          ...
          <path
            d="M40 38 Q45 42 50 38 Q55 42 60 38"
            stroke="#8E44AD"
            strokeWidth="2"
            fill="none"
          />

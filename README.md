...
- **강화된 공유 기능**:
  ...
  - 🔗 **링크 복사**: 결과별 전용 공유 URL
  - 📸 **이미지 저장**: html-to-image로 결과 캡쳐
- **동적 미리보기**: 링크 공유 시 해당 유형의 맞춤 이미지와 메타데이터 표시
...
| 유형               | 아이콘 | 특징                           | 추천 직무                          |
| ------------------ | ------ | ------------------------------ | ---------------------------------- |
| 외향형 (Extrovert) | 🚀     | 적극적, 사교적, 에너지 넘치는  | 영업, 마케팅, HR, 이벤트 기획      |
| 내향형 (Introvert) | 🌙     | 신중한, 집중력 좋은, 깊이 있는 | 개발자, 연구원, 분석가, 디자이너   |
| 감정형 (Emotion)   | ❤️     | 공감능력, 협력적, 따뜻한       | 상담사, 교육, 고객서비스, 사회복지 |
| 사고형 (Thought)   | 🧠     | 논리적, 분석적, 체계적         | 기획자, 전략가, 재무, 컨설턴트     |
...
```typescript
// src/lib/shareUtils.ts에서 공유 텍스트 수정
// 카카오톡, 링크 복사, 이미지 저장 기능 각각 커스터마이징 가능
```
